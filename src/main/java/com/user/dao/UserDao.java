...
public class UserDao {
	...
	public  Users updateDetails(String userName, String userEmail, String userDesignation, String userSalary,
			String userPassword, Users users) {
		if(users!=null) {
			users.setUser_Name(userName);
			users.setUser_Email(userEmail);
			users.setUser_Password(userPassword);
			users.setUser_Designation(userDesignation);
			users.setUser_Salary(Double.parseDouble(userSalary));
